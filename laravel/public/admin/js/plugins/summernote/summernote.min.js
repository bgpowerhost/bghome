...
function uploadFile() {
	...
	if(allowed_extensions.indexOf(file_ext) > -1) {
		uploadData(file, '/adminpanel/menus/footer/footer-images', 'images')
	} else {
...
function uploadData(file,url,type) {
	var fd = new FormData();
	fd.append("file", file);
